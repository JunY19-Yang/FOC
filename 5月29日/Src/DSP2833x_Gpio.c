...
{
	EALLOW;
	GpioCtrlRegs.GPBMUX2.bit.GPIO49 = 0;	// 0=GPIO,  1=TZ3,  2=LINTX-A,  3=SPICLK-B  设置成GPIO(数字IO模式)
	GpioCtrlRegs.GPBDIR.bit.GPIO49 = 0;		// 1=OUTput,  0=INput                       作为输入方向
   GpioCtrlRegs.GPBPUD.bit.GPIO49 = 0;		// 使能内部上拉

	GpioCtrlRegs.GPBMUX2.bit.GPIO52 = 0;	// 0=GPIO,  1=TZ3,  2=LINTX-A,  3=SPICLK-B
	GpioCtrlRegs.GPBDIR.bit.GPIO52 = 0;		// 1=OUTput,  0=INput
   GpioCtrlRegs.GPBPUD.bit.GPIO52 = 0;	

	GpioCtrlRegs.GPBMUX2.bit.GPIO58 = 0;	// 0=GPIO,  1=TZ3,  2=LINTX-A,  3=SPICLK-B
